...
def main():
    dir0 = '/Users/chenrui/Desktop/602/ChenRui_hw9/duplicate_examples/zero/'
    files = []
    for file in listdir('/Users/chenrui/Desktop/602/ChenRui_hw9/duplicate_examples/zero'):
        if file.endswith(".png"):
            files.append(dir0+file)
    ...
    # write to file 
    with open("answers_myresult.txt", "w") as text_file:
